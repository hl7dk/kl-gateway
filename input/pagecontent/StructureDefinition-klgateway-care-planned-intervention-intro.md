...
PlannedIntervention follow-up is documented using GeneralEncounter, which holds a reference to the PlannedIntervention (using the basedOnIntervention extension).
